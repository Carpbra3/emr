...
<section class="form-group required ${hasErrors(bean: patientInstance, field: 'firstName', 'has-error')}">
    <section class="row">
        ...
        <section class="col-md-6">
            <g:textField class="form-control" id="firstName" name="firstName" value="${patientInstance?.firstName}"
                         required="true"
                         autofocus="true"/>
        </section>
    </section>
...
<section class="form-group required ${hasErrors(bean: patientInstance, field: 'lastName', 'has-error')}">
    <section class="row">
        ...
        <section class="col-md-6">
            <g:textField class="form-control" id="lastName" name="lastName" value="${patientInstance?.lastName}"
                         required="true"/>
        </section>
    </section>
</section>
...
<section class="form-group required ${hasErrors(bean: patientInstance, field: 'dateOfBirth', 'has-error')}">
    <section class="row">
        ...
        <section class="col-md-6">
            <g:datePicker precision="day" class="form-control" id="dateOfBirth" name="dateOfBirth"
                          value="${patientInstance?.dateOfBirth}" required="true"/>
        </section>
    </section>
</section>
